...
let users = [
  { FirstName: "Jenish", LastName: "Bhalani", email: "jenish@example.com" },
  { FirstName: "Vasu", LastName: "Kinderkhediya", email: "vasu@example.com" }
];
let messages = [
  { FirstName: "Ankit", LastName: "Mandaviya", email: "ankit@mail.com", message: "Great site!" },
  { FirstName: "Bhaumik", LastName: "Parmar", email: "bhaumik@mail.com", message: "Need help with login." }
];
  ...
  selects.forEach(select => {
    ...
    options.forEach(option => {
      option.addEventListener('click', () => {
        ...
        selected.classList.add('selected-active'); // sky-blue background
      });
    });
  });
